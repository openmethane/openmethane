...
date = obs_data[u'Date']
obs_date = obs_data[u'Date'].tolist()
obs_timestep = obs_data[u'timestep'].tolist()
obs_lay = obs_data[u'layer'].tolist()
obs_lat = obs_data[u'lat'].tolist()
obs_lon = obs_data[u'lon'].tolist()
obs_spec = obs_data[u'spec'].tolist()
...
obs_val_ppb = obs_data[u'obs'].tolist()
