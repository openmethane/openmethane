...
| `scripts/cmaq_preprocess/perturb_bcon.py` | Offsets the prepared run's boundary conditions by `--offset-ppb`, in place. Diagnostic: used to measure the column response to a known boundary perturbation, not part of a normal run. |
