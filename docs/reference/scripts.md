...
| `scripts/cmaq_preprocess/upload-domains.py` | Publishes domain files to the data store. Maintainers only; needs CloudFlare R2 credentials and a separately installed AWS CLI. |
