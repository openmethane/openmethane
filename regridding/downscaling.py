...
ncp = NetCDFFile("/scratch/q90/sa6589/test_Sougol/shared_Sougol/gpw_2020_30_sec.nc") ##path to the GPW data
ncp2 = NetCDFFile("/scratch/q90/sa6589/test_Sougol/shared_Sougol/gpw_2015_30_sec.nc") ##path to the GPW data
...
## Creat a factor for extrapolating the EDGAR emissions 
    ...
    for i1 in range(0, shape1[0]):
        for j1 in range(0, shape1[1]):
            ...
            emi_matrix[i1,j1] = (emission[i1,j1]  * 123.21 * 1e6) #this factor is used to convert the kg/s/m2 to kg/s 
    ...
    emission_Aus = Dataset('/scratch/q90/sa6589/test_Sougol/shared_Sougol/downscaling_out/emission_{}.nc'.format(month), 'w', format='NETCDF4_CLASSIC')
    ...
    from netCDF4 import Dataset
    emission_population = Dataset('/scratch/q90/sa6589/test_Sougol/shared_Sougol/downscaling_out/emission_downscaled_{}.nc'.format(month), 'w', format='NETCDF4_CLASSIC')
